...
$sql = "SELECT t.ticket_id, t.number FROM ost_ticket t WHERE t.ticket_id IN (SELECT da.id_ticket FROM ost_dictaminacion_asignaciones da WHERE da.id_staff ='$agent_id')";
$res = db_query($sql);
